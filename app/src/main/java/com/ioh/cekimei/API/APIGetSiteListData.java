...
public class APIGetSiteListData extends StringRequest {

    private SharedPreferences sharedPreferences;
    private Map<String, String> params;

    public APIGetSiteListData(Context context, String dsf_username,
                          Response.Listener<String> listener, Response.ErrorListener errorListener) {
        super(Request.Method.POST, context.getResources().getString(R.string.url_get_site_list_data), listener, errorListener);
        params = new HashMap<>();
        ...
        params.put("activity", "Get Site List Data");
    }
