        ...
        listener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    progressDialog.cancel();
                    APICheckIMEI my_api = new APICheckIMEI(getApplicationContext(), auth, check_imei, "Success",status);
        ...
        listener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(status){
                        if (show) Toast.makeText(MainActivity.this, "Hi "+data_name, Toast.LENGTH_SHORT).show();
                    }else{
                        editor.clear();
                        editor.commit();
                        Intent intent = new Intent(getApplicationContext(), Login.class);
